...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da1 = new SqlDataAdapter("select * from category where catname='" + TextBox1.Text + "'", cn);
        DataSet ds1 = new DataSet();
        da1.Fill(ds1);
        if (ds1.Tables[0].Rows.Count > 0)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "title", "alert('Category Name Already Exist');", true);
        }
        ...
        else
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select max(catid) from category", cn);
            ...
            string s = "insert into category values ('" + id + "','" + TextBox1.Text + "')";
