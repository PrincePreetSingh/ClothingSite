<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="vieworders.aspx.cs" Inherits="Admin_Default" Title="Untitled Page" %>
...
<tr><td width="50%" colspan="2" style="width: 100%" align="center">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="orderid" Text="More Detail" DataNavigateUrlFormatString="vieworderdetail.aspx?oid={0}" ControlStyle-ForeColor="Gray" />
        </Columns>
