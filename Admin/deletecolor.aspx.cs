...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    {
         SqlDataAdapter da = new SqlDataAdapter("select * from product where colorid='" + DropDownList2.SelectedValue + "'", cn);
            DataSet ds = new DataSet();
            da.Fill(ds);
            if (ds.Tables[0].Rows.Count > 0)
            {
            ...
            {
                string s = "delete from color where Color_id='" + DropDownList2.SelectedValue + "'";
