<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="updateproduct.aspx.cs" Inherits="Admin_Default" Title="Untitled Page" %>
...
<tr>
<td colspan="2" class="toptdback">Update Product</td>
</tr>
...
<tr><td width="50%">&nbsp;</td><td width="50%">
    <asp:CompareValidator ID="CompareValidator4" runat="server" 
        ControlToValidate="DropDownList4" Display="None" ErrorMessage="Select Brand" 
        Operator="NotEqual" ValueToCompare="Select"></asp:CompareValidator>
    </td></tr>
...
<tr><td width="50%">&nbsp;</td><td width="50%">
    <asp:CompareValidator ID="CompareValidator5" runat="server" 
        ControlToValidate="DropDownList5" Display="None" ErrorMessage="Select Size" 
        Operator="NotEqual" ValueToCompare="Select"></asp:CompareValidator>
    </td></tr>
...
<tr><td width="50%" class="lefttext">
    Product For</td><td width="50%" align="left">
...
<tr><td width="50%" class="lefttext">
    <asp:CompareValidator ID="CompareValidator6" runat="server" 
        ControlToValidate="DropDownList6" Display="None" 
        ErrorMessage="Select Product For" Operator="NotEqual" ValueToCompare="Select"></asp:CompareValidator>
    </td><td width="50%" align="left">
        &nbsp;</td></tr>


<tr><td width="50%" class="lefttext">Old Pic1</td><td width="50%" align="left">
...
<tr><td width="50%" class="lefttext">
    Old Pic2</td><td width="50%" align="left">
        <asp:Image ID="Image2" runat="server" Height="68px" Width="68px" />
